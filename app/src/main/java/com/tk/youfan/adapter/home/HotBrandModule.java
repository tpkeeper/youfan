...
/**
 * 作者：tpkeeper on 2016/9/28 20:34
 * 微信：lzy1056883354
 * QQ号：1056883354
 * 作用：xxxx
 */
public class HotBrandModule extends BaseHolder {
    TextView c_title;
    TextView e_title;
    GridView gridview;
    private List<Data> dataList;

    public HotBrandModule(Context mContext, View itemView) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            img_grid.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String brand_code = data.getJump().getName();
